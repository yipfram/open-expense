...
export default async function ServiceUnavailablePage({ searchParams }: ServiceUnavailablePageProps) {
  ...
  return (
    <main className="mx-auto flex w-full max-w-3xl min-w-0 flex-col gap-3 px-4 py-10 sm:px-6">
      ...
      {ref ? <p className="break-all text-sm text-slate-500">Reference: {ref}</p> : null}
      <p className="text-sm">
